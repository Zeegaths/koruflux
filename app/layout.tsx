...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Web3 regulatory compliance East Africa",
    "DeFi market entry Africa",
    "RWA tokenization Africa",
    "blockchain compliance Nairobi",
    "crypto market entry Kenya",
    "Web3 frontier markets consultancy",
    "DeFi compliance East Africa",
    "tokenization emerging markets",
    "Web3 East Africa",
    "crypto jurisdiction intelligence Africa",
  ],
  alternates: {
